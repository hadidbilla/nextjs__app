...
function ElectronicsAdEditForm({ ad, t }) {
...
ElectronicsAdEditForm.getInitialProps = async () => ({
  namespacesRequired: ["ad-form"],
});
export default withTranslation("ad-form")(ElectronicsAdEditForm);
