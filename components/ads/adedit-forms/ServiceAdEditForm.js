...
function ServiceAdEditForm({ ad, t }) {
...
ServiceAdEditForm.getInitialProps = async () => ({
  namespacesRequired: ["ad-form"],
});
export default withTranslation("ad-form")(ServiceAdEditForm);
