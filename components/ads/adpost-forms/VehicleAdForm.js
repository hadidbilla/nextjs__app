  ...
  return (
    <div>
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Button type="submit" className="btn btn-block bg-primary-btn">
...
VehicleAdForm.getInitialProps = async () => ({
  namespacesRequired: ["ad-form"],
});
export default withTranslation("ad-form")(VehicleAdForm);
